...
opcion = StringVar()
opcion.set(None)
Radiobutton(root, text="Peugeot", variable=opcion, value='Peugeot', command=seleccionar).pack(anchor=W)
...
Radiobutton(root, text="Seat", variable=opcion, value='Seat', command=seleccionar).pack(anchor=W)
